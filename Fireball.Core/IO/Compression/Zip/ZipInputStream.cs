...
using Fireball.IO.Compression.Checksums;
using Fireball.IO.Compression.Zip.Compression;
using Fireball.IO.Compression.Zip.Compression.Streams;
using Fireball.IO.Compression.Encryption;

namespace Fireball.IO.Compression.Zip 
{
	/// <summary>
	...
	public class ZipInputStream : InflaterInputStream
	{
		...
		/// </exception>
		/// <exception name="Fireball.IO.Compression.ZipException">
